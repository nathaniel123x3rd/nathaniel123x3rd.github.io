...
const exp = [
  ...
  {
    title: "Bot Developer",
    cardImage: "assets/images/experience-page/arbotix.png",
    place: "Arbotix",
    time: "(March 20 - Present)",
    desp:"<li>Worked on creating a web dashboard for api.</li><li>Designed 100% responsive description for showcase websites. <li>Currently working on a staff page to monitor audit logs from the api. Also co-created our proud verified api.</li></li>",
  },
];
